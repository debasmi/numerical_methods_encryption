...
for name, method_function in methods_dict.items():
    ...
    cv2.imwrite(f"/Users/debasmibasu/Documents/MATHS SEM 6/rossler/encrypted_{name}.png", encrypted)

    # Control encryption
    control = control_encryption(img)
    cv2.imwrite(f"/Users/debasmibasu/Documents/MATHS SEM 6/rossler/control_{name}.png", control)
